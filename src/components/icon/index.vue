<template>
  <div class="wrapper" :style="style">
    <div class="brand" v-if="name === 'brand'">
      ...
      <img class="brand" src="./brand@2x.png" width="100%" height="100%" v-else />
    </div>
    <div class="discount" v-else-if="name === 'discount'">
      ...
      <img class="discount" src="./discount_1@2x.png" width="100%" height="100%" v-else-if="ratio === 1" />
    </div>
    <div class="decrease" v-else-if="name === 'decrease'">
      ...
      <img class="decrease" src="./decrease_1@2x.png" width="100%" height="100%" v-else-if="ratio === 1" />
    </div>
    <div class="guarantee" v-else-if="name === 'guarantee'">
      ...
      <img class="guarantee" src="./guarantee_1@2x.png" width="100%" height="100%" v-else-if="ratio === 1" />
    </div>
    <div class="special" v-else-if="name === 'special'">
      ...
      <img class="special" src="./special_1@2x.png" width="100%" height="100%" v-else-if="ratio === 1" />
    </div>
    <div class="invoice" v-else-if="name === 'invoice'">
      ...
      <img class="invoice" src="./invoice_1@3x.png" width="100%" height="100%" v-else-if="ratio === 1" />
    </div>
